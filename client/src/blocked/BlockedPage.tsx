  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 flex items-center justify-center font-sans">
      <div className="text-center max-w-2xl px-10 py-12">
        ...
        <h1 className="text-5xl font-bold text-gray-800 dark:text-gray-100 mb-4">Site Blocked</h1>

        <p className="text-2xl text-gray-600 dark:text-gray-400 mb-10">{hostname}</p>
          ...
          <>
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="bg-green-500 hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-700 disabled:bg-gray-400 dark:disabled:bg-gray-600 disabled:cursor-not-allowed text-white font-semibold px-10 py-4 rounded-lg transition-colors text-lg"
              >
              ...
              <div className="border-t-2 border-gray-200 dark:border-gray-700 pt-4 mt-2">
                {!showTodoInput ? (
                  <button
                    ...
                    className="bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 text-white font-semibold px-10 py-4 rounded-lg transition-colors text-lg w-full"
                  >
                    Remind Me Later
                  </button>
                ) : (
                  <div>
                    <label className="block mb-2 text-gray-700 dark:text-gray-300 font-medium text-base">
                      Optional note:
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full px-4 py-2 mb-3 text-base border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 rounded-lg focus:outline-none focus:border-blue-500 dark:focus:border-blue-400"
                    />
                    <div className="flex gap-2">
                      <button
                        onClick={handleSaveTodoReminder}
                        className="flex-1 bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-lg transition-colors"
                      >
                        Save Reminder
                      </button>
                      <button
              ...
              <button
                ...
                disabled={loading}
                className="bg-gray-600 hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600 disabled:bg-gray-400 dark:disabled:bg-gray-600 text-white font-semibold px-10 py-4 rounded-lg transition-colors text-lg"
              >
                Go Back
              </button>
            </div>
